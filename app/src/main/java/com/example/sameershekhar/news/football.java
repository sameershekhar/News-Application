...
public static  RecyclerView recyclerView;
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(final LayoutInflater inflater, final ViewGroup parent) {
            super(inflater.inflate(R.layout.fragment_football, parent, false));
    ...
    public static class ContentAdapter extends RecyclerView.Adapter<ViewHolder> implements Filterable {
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            Glide.with(context).load(footballArray.get(position).getUrltoImage()).into(holder.picture);
    ...
    public static void shareInfromation(int pos, String name, String description)
    {
